...
(function (TcHmi) {
    ...
    (function (Controls) {
        ...
        (function (TcHmiExtendedControls) {
            class MultiselectCombobox extends TcHmi.Controls.Beckhoff.TcHmiCombobox {
                /*
                ...
                */
                ...
                __selectionArray = [];
                // styling
                __dropDownCheckboxBackgroundColor;
                __dropDownCheckboxCheckColor;
                // events/watchers
                __dropdownMutationObserver;
                // internal
                __updatingSrcData;
                /**
                ...
                __setSelectedIndex(valueNew, forwardToEnumDataSymbol = !0, forwardToSelectedId = !0) {
                ...
                __processSelectedIndex(forwardToEnumDataSymbol, forwardToSelectedId) {
                    ...
                    if (this.__selectedIndex !== null && this.__selectedIndex !== undefined && this.__selectedIndex >= 0 && this.__selectedIndex < this.__data.length) {
                        ...
                        const selectedItemCheckbox = checkboxElems[this.__selectedIndex];
                        if (!this.__allowTextInput) {
                            ...
                            if (this.__selectedTexts.includes(this.__data[this.__selectedIndex].text)) {
                                ...
                                let selIds = this.__selectedIds;
                                let selId = this.__data[this.__selectedIndex].id;
                ...
                __processSrcData(forwardToEnumDataSymbol) {
                ...
                /**
                    ...
                    */
                __removeTmlClassCallback(mutationsList) {
                ...
                __resizeCheckbox() {
                    ...
                    checkboxElems.labels.forEach((label) => {
                    ...
                    checkboxElems.checkboxes.forEach((checkbox) => {
                    ...
                    checkboxElems.spans.forEach((span) => {
                ...
                __replaceSpecialChars(selector) {
                ...
                __checkBoxes() {
                    ...
                    checkboxElems.forEach((cb, index) => {
                ...
                /**
                    * Selected Indexes
                    */
                setSelectedIndexes(valueNew) {
                    // check if the converted value is valid
                    if (valueNew === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        valueNew = this.getAttributeDefaultValueInternal('SelectedIndexes');
                    }
                ...
                /**
                    * Selected Ids
                    */
                setSelectedIds(valueNew) {
                    // check if the converted value is valid
                    if (valueNew === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        valueNew = this.getAttributeDefaultValueInternal('SelectedIds');
                    }
                ...
                setDropDownCheckboxBackgroundColor(valueNew) {
                    let convertedValue = TcHmi.ValueConverter.toObject(valueNew);
                    if (convertedValue === null) {
                        convertedValue = this.getAttributeDefaultValueInternal("DropDownCheckboxBackgroundColor");
                    }
                ...
                __onResolverForDropDownCheckboxBackgroundColorWatchCallback;
                getDropDownCheckboxBackgroundColor() {
                    return this.__dropDownCheckboxBackgroundColor;
                }
                __processDropDownCheckboxBackgroundColor() {
                    const spanElems = this.__queryCheckboxElems().spans;
                ...
                setDropDownCheckboxCheckColor(valueNew) {
                    let convertedValue = TcHmi.ValueConverter.toObject(valueNew);
                    if (convertedValue === null) {
                        convertedValue = this.getAttributeDefaultValueInternal("DropDownCheckboxCheckColor");
                    }
                ...
                __onResolverForDropDownCheckboxCheckColorWatchCallback;
                getDropDownCheckboxCheckColor() {
                    return this.__dropDownCheckboxCheckColor;
                }
                __processDropDownCheckboxCheckColor() {
                    const spanElems = this.__queryCheckboxElems().spans;
                    spanElems.forEach((span, index) => {
                        const path = span.querySelector(`.${this.__replaceSpecialChars(this.__id)}-multiselect-svg-path`);
                        TcHmi.StyleProvider.processStrokeColor(path, this.__dropDownCheckboxCheckColor);
                    });
                }
            }
            TcHmiExtendedControls.MultiselectCombobox = MultiselectCombobox;
