...
(function (TcHmi) {
    ...
    (function (Controls) {
        ...
        (function (TcHmiExtendedControls) {
            class RangeSlider extends TcHmi.Controls.System.TcHmiControl {
                /*
                ...
                */
                ...
                setStep(valueNew) {
                    ...
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('Step');
                    }
                ...
                /**
                    * View Only
                    */
                setViewOnly(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toBoolean(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('ViewOnly');
                    }
                ...
                /**
                    * Accent Color
                    */
                setAccentColor(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toObject(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('AccentColor');
                    }
            ...
            TcHmiExtendedControls.RangeSlider = RangeSlider;
