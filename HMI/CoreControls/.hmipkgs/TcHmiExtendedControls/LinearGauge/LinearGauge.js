...
(function (TcHmi) {
    ...
    (function (Controls) {
        ...
        (function (TcHmiExtendedControls) {
            class LinearGauge extends TcHmi.Controls.System.TcHmiControl {
                /*
                ...
                */
                ...
                __previnit() {
                    ...
                    this.__resizeEventDestroyFunction = TcHmi.EventProvider.register(this.__id + '.onResized', this.__resizeGauge());
                ...
                /**
                    ...
                    */
                setBorderRadius(valueNew) {
                    // override parent setBorderRadius and set radius of gauge background bar and foreground bar
                    this.__gaugeBackground.css('border-radius', `${valueNew?.topLeft}${valueNew?.topLeftUnit}
                    ...
                    this.__gaugeForeground.css('border-radius', `${valueNew?.topLeft}${valueNew?.topLeftUnit}
                        ${valueNew?.topRight}${valueNew?.topRightUnit}
                        ${valueNew?.bottomRight}${valueNew?.bottomRightUnit}
                        ${valueNew?.bottomLeft}${valueNew?.bottomLeftUnit}`);
                ...
                /**
                    * Orientation
                    */
                setOrientation(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toString(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('Orientation');
                    }
                ...
                /**
                    * Progress Animation
                    */
                setProgressAnimation(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toBoolean(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('ProgressAnimation');
                    }
            ...
            TcHmiExtendedControls.LinearGauge = LinearGauge;
