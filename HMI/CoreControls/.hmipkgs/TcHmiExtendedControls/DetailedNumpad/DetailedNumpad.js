...
(function (TcHmi) {
    ...
    (function (Controls) {
        ...
        (function (TcHmiExtendedControls) {
            class DetailedNumpad extends TcHmi.Controls.Beckhoff.TcHmiKeyboard {
                /*
                ...
                */
                ...
                __inputControl;
                // events/watchers
                __onNumericInputPropChangedDestroyEvent;
                /**
                ...
                __onResolverForConfigDataCallback = (data) => {
                ...
                /**
                    * Input Control
                    */
                setInputControl(valueNew) {
                    let convertedValue = valueNew;
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('InputControl');
                    }
            ...
            TcHmiExtendedControls.DetailedNumpad = DetailedNumpad;
...
//# sourceMappingURL=DetailedNumpad.js.map