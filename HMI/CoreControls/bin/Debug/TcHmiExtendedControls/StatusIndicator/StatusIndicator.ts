...
namespace TcHmi.Controls {
    export namespace TcHmiExtendedControls {
        export class StatusIndicator extends TcHmi.Controls.Beckhoff.TcHmiEllipse {
            ...
            */
            ...
            protected __indicatorElement: JQuery;
            protected __indicatorSvg: JQuery;
            protected __indicatorEllipse: JQuery;

            // properties
            protected __stateSymbol: boolean;
            protected __fillColorTrue: Color;
            protected __fillColorFalse: Color;
            protected __label: string;
            protected __labelPosition: LabelPosition;
            protected __indicatorScale: number;
            ...
            public setStateSymbol(valueNew: boolean | null): void {
                ...
                if (convertedValue === null) {
                    ...
                    convertedValue = this.getAttributeDefaultValueInternal('StateSymbol') as boolean;
                }
            ...
            public getStateSymbol() {
                return this.__stateSymbol;
            }

            protected __processStateSymbol() {
            ...
            public setFillColorTrue(valueNew: Color | null | undefined) {

                // convert the value with the value converter
                let convertedValue: Color | null = TcHmi.ValueConverter.toObject(valueNew);

                // check if the converted value is valid
                if (convertedValue === null) {
                    // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                    convertedValue = this.getAttributeDefaultValueInternal('FillColorTrue') as Color;
                }
            ...
            public getFillColorTrue() {
                return this.__fillColorTrue;
            }

            protected __processFillColorTrue() {
            ...
            public setFillColorFalse(valueNew: Color | null | undefined) {
                ...
                if (convertedValue === null) {
                    // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                    convertedValue = this.getAttributeDefaultValueInternal('FillColorFalse') as Color;
                }
            ...
            public getFillColorFalse() {
                return this.__fillColorFalse;
            }

            protected __processFillColorFalse() {
            ...
            * Indicator Scale
            */
            public setIndicatorScale(valueNew: number): void {
                ...
                if (convertedValue === null) {
                    // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                    convertedValue = this.getAttributeDefaultValueInternal('IndicatorScale') as number;
                }
            ...
            public getIndicatorScale(): number {
                return this.__indicatorScale;
            }

            protected __processIndicatorScale(): void {
