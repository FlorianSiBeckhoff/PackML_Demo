...
namespace TcHmi.Controls {
    export namespace TcHmiExtendedControls {
        export class ConfirmationButton extends TcHmi.Controls.Beckhoff.TcHmiButton {
            ...
            */
            ...
            // properties
            protected __requireConfirmation: boolean | null;
            protected __confirmationMessage: string;
            ...
            protected __writeState(state: boolean, source: string) {
            ...
            protected __onMouseLeave(event) {
            ...
            protected __onTouchEndOrCancel(event) {
                if (0 === this.__touches.length)
                    return;
                const activeTouchIds = Array.from(event.touches).map(((touch: any) => touch.identifier));
            ...
            public setRequireConfirmation(requireConfirm) {
            ...
            public setConfirmationMessage(confirmMessage) {
