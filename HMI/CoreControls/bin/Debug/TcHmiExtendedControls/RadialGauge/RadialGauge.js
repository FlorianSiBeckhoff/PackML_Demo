...
(function (TcHmi) {
    ...
    (function (Controls) {
        ...
        (function (TcHmiExtendedControls) {
            class RadialGauge extends TcHmi.Controls.System.TcHmiControl {
                /*
                ...
                */
                ...
                __valueFontSizeUnit;
                __minMaxFontSize;
                __minMaxFontSizeUnit;
                __backgroundBarColor;
                // events/watchers
                __resizeEventDestroyFunction;
                __themeDataLoadedEventDestroyEvent;
                // internal
                __x;
                __y;
                __radius;
                ...
                __previnit() {
                    ...
                    this.__resizeEventDestroyFunction = TcHmi.EventProvider.register(this.__id + '.onResized', this.__resizeCanvas());
                ...
                __createCanvas() {
                    ...
                    this.__gaugeCtx = this.__gaugeCanvas.getContext('2d');
                ...
                /**
                    * Show Value
                    */
                setShowValue(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toBoolean(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('ShowValue');
                    }
                ...
                /**
                    * Range Colors
                    */
                setRangeColors(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = valueNew;
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('RangeColors');
                    }
                ...
                __onResolverForRangeColorsWatchCallback = (data) => {
                ...
                /**
                    * Show Min Max
                    */
                setShowMinMax(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toBoolean(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('ShowMinMax');
                    }
                ...
                /**
                    * Gauge Width
                    */
                setGaugeWidth(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toNumber(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('GaugeWidth');
                    }
                ...
                /**
                    * Round Gauge
                    */
                setRoundGauge(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toBoolean(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('RoundGauge');
                    }
                ...
                __onResolverForTextColorWatchCallback;
                getTextColor() {
                ...
                /**
                    * Min Max Styling
                    */
                setMinMaxFontSize(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toNumber(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('MinMaxFontSize');
                    }
                ...
                __processMinMaxFontSize() {
                    this.__minMaxDiv.css('font-size', `${this.__minMaxFontSize}${this.__minMaxFontSizeUnit}`);
                    this.__handleGauge();
                }
                setMinMaxFontSizeUnit(valueNew) {
                    // convert the value with the value converter
                    let convertedValue = TcHmi.ValueConverter.toFontSizeUnit(valueNew);
                    // check if the converted value is valid
                    if (convertedValue === null) {
                        // if we have no value to set we have to fall back to the defaultValueInternal from description.json
                        convertedValue = this.getAttributeDefaultValueInternal('MinMaxFontSizeUnit');
                    }
                ...
                getMinMaxFontSizeUnit() {
                    return this.__minMaxFontSizeUnit;
                }
                __processMinMaxFontSizeUnit() {
                    this.__processMinMaxFontSize();
                }
                /**
                    * Background Bar Styling
                    */
                setBackgroundBarColor(valueNew) {
                    let convertedValue = TcHmi.ValueConverter.toObject(valueNew);
                    if (convertedValue === null) {
                        convertedValue = this.getAttributeDefaultValueInternal("BackgroundBarColor");
                    }
                ...
                __onResolverForBackgroundBarColorWatchCallback;
                getBackgroundBarColor() {
                    return this.__backgroundBarColor;
                }
                __processBackgroundBarColor() {
                    this.__handleGauge();
                }
            }
            TcHmiExtendedControls.RadialGauge = RadialGauge;
