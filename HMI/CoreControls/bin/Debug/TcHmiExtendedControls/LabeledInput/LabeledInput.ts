...
namespace TcHmi.Controls {
    export namespace TcHmiExtendedControls {
        export class LabeledInput extends TcHmi.Controls.Beckhoff.TcHmiTextbox {
            ...
            */
            ...
            protected __templateBorderElement: JQuery;
            ...
            protected __unitWordWrap: boolean | undefined;
            ...
            setUnitWordWrap(valueNew: boolean | null): void {

                let convertedValue = TcHmi.ValueConverter.toBoolean(valueNew);

                if (convertedValue === null) {
                    convertedValue = this.getAttributeDefaultValueInternal("UnitWordWrap") as boolean;
                }
            ...
            getUnitWordWrap(): boolean | undefined {
                return this.__unitWordWrap
            }

            __processUnitWordWrap(): void {
