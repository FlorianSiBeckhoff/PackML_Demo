import { Controls, ObjectResolver, TcHmiControl, type AccessControl, type DestroyFunction, type FontSizeUnit, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiBreadcrumb<ContentType = string> extends TcHmiControl.Control {
    #private;
    /**
